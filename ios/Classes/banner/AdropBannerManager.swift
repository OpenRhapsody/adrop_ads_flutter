...
class AdropBannerManager: NSObject, AdropBannerDelegate {
    ...
    func onAdClicked(_ banner: AdropAds.AdropBanner) {
        adropChannel().invokeMethod(AdropMethod.DID_CLICK_AD, arguments: ["unitId":banner.unitId, "creativeId": banner.creativeId])
    }
    ...
    func onAdReceived(_ banner: AdropBanner) {
        adropChannel().invokeMethod(AdropMethod.DID_RECEIVE_AD, arguments: ["unitId":banner.unitId, "creativeId": banner.creativeId])
    }
}
